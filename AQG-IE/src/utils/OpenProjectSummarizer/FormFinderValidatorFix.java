...
public class FormFinderValidatorFix {
	...
	public static void main(String[] args) throws IOException, ParserException {
		...
		String databasesInterfaces = "/home/pjbarrio/Documents/RelationExtractionStuff/DatabasesInterfaces/SecondRound/Sites/DataToFix/";
		
		String databasesInterfacesForm = "/home/pjbarrio/Documents/RelationExtractionStuff/DatabasesInterfaces/SecondRound/Sites/SearchFormsToFix/";
...
//			System.err.println(file);
	...
	private static ArrayList<String> searchForms(File file) throws ParserException {
		...
		if (sfc.hasForm(file.getAbsolutePath())){
			...
			ret.addAll(sfc.getNonSearchableForms());
