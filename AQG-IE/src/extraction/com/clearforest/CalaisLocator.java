...
public class CalaisLocator extends org.apache.axis.client.Service implements extraction.com.clearforest.Calais {
    ...
    public extraction.com.clearforest.CalaisSoap getcalaisSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            extraction.com.clearforest.CalaisSoapSoapBindingStub _stub = new extraction.com.clearforest.CalaisSoapSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (extraction.com.clearforest.CalaisSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                extraction.com.clearforest.CalaisSoapSoapBindingStub _stub = new extraction.com.clearforest.CalaisSoapSoapBindingStub(new java.net.URL(calaisSoap_address), this);
                _stub.setPortName(getcalaisSoapWSDDServiceName());
                return _stub;
            }
        }
