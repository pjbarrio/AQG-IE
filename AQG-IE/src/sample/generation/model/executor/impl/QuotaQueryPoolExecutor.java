...
public class QuotaQueryPoolExecutor<T> extends ReScheduleQueryPoolExecutor<T> {

	public QuotaQueryPoolExecutor(QueryPool<T> queryPool,
	...
	protected List<T> regenerateQueryPool(List<Integer> queriesTokeep,
		...
		Collections.sort(queriesTokeep, new BooleanCountBasedComparator(documents));
