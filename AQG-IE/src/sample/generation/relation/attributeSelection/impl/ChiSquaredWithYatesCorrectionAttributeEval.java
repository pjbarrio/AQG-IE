 ...
 * @see NumericToBinary
 */
public class ChiSquaredWithYatesCorrectionAttributeEval
...
implements AttributeEvaluator, OptionHandler {
	...
	private static final double EXPECTED = 5.0;
	 ...
	 * Constructor
	 */
	public ChiSquaredWithYatesCorrectionAttributeEval() {
		resetOptions();
	}
   ...
   <!-- options-end -->
	...
	public static void main (String[] args) {
		runEvaluator(new ChiSquaredWithYatesCorrectionAttributeEval(), args);
	}
