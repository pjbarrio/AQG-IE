...
import searcher.lucene.StreamCollector;
...
private StreamCollector streamingHitCollector;
...
/**
  ...
  public void doStreamingSearch(final Searcher searcher, Query query) throws IOException {
	  ...
	  streamingHitCollector = new StreamCollector(searcher);

	  searcher.search(query, streamingHitCollector);

	  streamingHitCollector.sortbyScore();
...
public Hashtable<Document, Float> getScores() {
	...
	return streamingHitCollector.getScores();
	
}

public ArrayList<Document> getSortedDocuments() {
	
	return streamingHitCollector.getSortedDocuments();
