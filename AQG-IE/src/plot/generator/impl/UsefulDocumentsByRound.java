...
public class UsefulDocumentsByRound extends SampleGenerationSeriesGenerator {
	...
	protected Series generateSeries(List<Hashtable<String, Double>> list,
		...
		for (Hashtable<String, Double> hashtable : list) {
			...
			if (lastRound > lastExploredRound){
				...
				ret.addPair(Pair.getPair(lastExploredRound/normalizeXValue, added/normalizeYValue));
	...
	public String getTitle() {
		...
		return "Useful Documents By Round";
