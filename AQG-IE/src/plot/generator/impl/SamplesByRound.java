...
public class SamplesByRound extends SampleGenerationSeriesGenerator {
	...
	protected Series generateSeries(List<Hashtable<String, Double>> list,
		...
		for (Hashtable<String, Double> hashtable : list) {
			...
			if (lastRound > lastExploredRound){
				...
				ret.addPair(Pair.getPair(lastExploredRound/normalizeXValue, querySent/normalizeYValue));
